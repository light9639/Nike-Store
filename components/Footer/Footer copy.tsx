...
export default function Footer(): JSX.Element {
    return (
        <div className='dark:bg-gray-900 w-screen border-t dark:border-none'>
            <footer className="dark:text-white pt-12 pb-8">
                <div className="container overflow-hidden flex flex-col lg:flex-row justify-between mx-auto px-4">
                    ...
                    <div className="w-3/4 block sm:flex text-sm mt-6 lg:mt-0">
                        <ul className="dark:text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                            <li className="inline-block py-2 px-3 dark:text-white uppercase font-medium tracking-wide">이용안내</li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">검수기준</a></li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">이용정책</a></li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">페널티 정책</a></li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">커뮤니티 가이드라인</a></li>
                        </ul>
                        <ul className="dark:text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                            <li className="inline-block py-2 px-3 dark:text-white uppercase font-medium tracking-wide">고객지원</li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">공지사항</a></li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">서비스 소개</a></li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">쇼룸 안내</a></li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">판매자 방문접수</a></li>
                        </ul>
                        <ul className="dark:text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                            <li className="inline-block py-2 px-3 dark:text-white uppercase font-medium tracking-wide">판매물품</li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">특징</a></li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">가격 안내</a></li>
                            <li><a href="#void" className="inline-block py-2 pl-3 pr-5 dark:text-gray-500 dark:hover:text-white no-underline">FAQ</a></li>
                        </ul>
                        <div className="dark:text-gray-700 flex flex-col w-full">
                            <div className="inline-block py-2 px-3 dark:text-white uppercase font-medium tracking-wide text-left">Follow Us</div>
                            <div className="flex pl-4 justify-start mt-2">
                                <a className="flex items-center dark:text-gray-300 dark:hover:text-white mr-6 no-underline" href="https://www.facebook.com/nike">
                                ...
                                <a className="flex items-center dark:text-gray-300 dark:hover:text-white mr-6 no-underline" href="https://twitter.com/nikecom_kr">
                                    <svg viewBox="0 0 24 24" className="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M23.954 4.569a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.691 8.094 4.066 6.13 1.64 3.161a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.061a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.937 4.937 0 004.604 3.417 9.868 9.868 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.054 0 13.999-7.496 13.999-13.986 0-.209 0-.42-.015-.63a9.936 9.936 0 002.46-2.548l-.047-.02z" /></svg>
                                </a>
                                <a className="flex items-center dark:text-gray-300 dark:hover:text-white no-underline" href="https://www.youtube.com/user/nike">
                ...
                <div className="mt-4 pt-6 dark:text-gray-600 border-none dark:border-t dark:border-gray-800 flex flex-col md:flex-row justify-center items-center">
                    <div>© 2020 Shoe Store Agency LLC.</div>
                    <div>&nbsp;All rights reserved.</div>
                </div>
            </footer>
        </div>
        // <footer aria-label="Site Footer" className="bg-white dark:bg-gray-900 border-t dark:border-none">
        //     <div className="mx-auto max-w-screen-2xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-16">
