...
export default function Nike_Kids(props: RouteType): JSX.Element {
    return (
        <div className="container mx-auto px-4 -mt-20" style={{ "maxWidth": "98%" }}>
            <Fade><img className='mx-auto max-w-full p-2 md:p-0 sm:max-w-md mb-10 rounded' src="https://raw.githubusercontent.com/light9639/ImgStorage/main/shoestore/index/Kids.png" alt="Nike" /></Fade>
            <Fade bottom>
                <p className="text-lg text-center">더 많은 키즈 신발을 만나보세요. <br />간단한 설문을 통해 아이에게 꼭 맞는 신발을 추천해 드립니다.</p>
