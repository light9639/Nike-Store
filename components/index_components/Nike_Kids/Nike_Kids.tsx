...
export default function Nike_Kids(props: RouteType): JSX.Element {
    return (
        <div className="container mx-auto px-4 -mt-20" style={{ "maxWidth": "98%" }}>
            <Fade><img className='mx-auto max-w-full p-2 md:p-0 sm:max-w-md mb-10' src="https://raw.githubusercontent.com/light9639/ImgStorage/main/shoestore/index/Kids.png" alt="Nike" /></Fade>
            <Fade bottom>
