    ...
    return (
        <div className='w-fit mx-auto flex items-center py-8'>
            <button
                ...
                className="h-12 w-14 font-semibold text-gray-800 hover:bg-blue-600 hover:text-white dark:bg-gray-200 dark:hover:bg-blue-600 text-sm flex items-center justify-center cursor-pointer rounded-lg border border-gray-200 dark:hover:border-blue-600 mr-3"
            >
                Prev
            </button>
            {
                Pages && Pages.fill().map((item: number[], idx: number) => (
                    <button
                        ...
                        className={`h-12 w-12 font-semibold hover:bg-blue-500 hover:text-white text-sm flex items-center justify-center cursor-pointer border border-gray-200 dark:hover:border-blue-600 rounded-lg mr-3
                            ${props.page === idx + 1 && "page" ? 'bg-blue-600 dark:bg-blue-600 dark:border-blue-600 text-white' : 'dark:bg-gray-200 text-gray-800'}`}
                    >
                        {idx + 1}
                    </button>
                ))
            ...
            <button
                ...
                className="h-12 w-14 font-semibold text-gray-800 hover:bg-blue-600 hover:text-white text-sm flex items-center justify-center cursor-pointer rounded-lg border border-gray-200 dark:bg-gray-200 dark:hover:border-blue-600 dark:hover:bg-blue-600"
            >
                Next
            </button>
        </div>
