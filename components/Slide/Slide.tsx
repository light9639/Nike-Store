                                    ...
                                    <Fade bottom cascade>
                                        <div className="pt-5 px-2 flex flex-col gap-2">
                                            ...
                                            <div className='tracking-tighter'>
                                                <p className='pb-1 xl:pb-2 text-sm text-gray-600 dark:text-white'>{item.info}</p>
                                                <span className="text-base xl:text-xl absolute right-3 -translate-y-16 mt-3 xl:mt-0">{item.price}</span>
                                            </div>
                                        </div>
                                        <div className="block lg:flex pl-2 pb-2">
                                            <span className="flex items-center my-3 lg:my-0">
                                                ...
                                                <span className={`bg-${item.color}-100 text-${item.color}-800 text-sm font-semibold ml-2 px-2.5 py-0.5 rounded dark:bg-${item.color}-200 dark:text-${item.color}-900`}>{item.Review} Reviews</span>
                                            </span>
                                            <span className="hidden lg:flex lg:ml-3 lg:pl-3 lg:py-2 lg:border-l-2 border-gray-200 space-x-2s gap-1 xl:gap-3">
                                                <a href='https://ko-kr.facebook.com/' className={`text-gray-500 dark:text-white transition hover:text-${item.color}-600 dark:hover:text-${item.color}-600`}>
                                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                                    </svg>
                                                </a>
                                                <a href='https://twitter.com/home' className={`text-gray-500 dark:text-white transition hover:text-${item.color}-600 dark:hover:text-${item.color}-600`}>
                                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                                        <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                                                    </svg>
                                                </a>
                                                <a href='https://www.kakaocorp.com/page/service/service/KakaoTalk' className={`text-gray-500 dark:text-white transition hover:text-${item.color}-600 dark:hover:text-${item.color}-600`}>
                                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
