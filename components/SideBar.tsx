...
export default function SideBar(props: { side: boolean; Name: string }): JSX.Element {
    ...
    return (
        <React.Fragment>
            <div
                className={`w-64 h-full bg-white shadow-lg dark:bg-slate-900 dark:border-gray-700 rounded-xl mr-3 hidden lg:block
                    ${props.side == true ? 'relative duration-[1.25s] top-0 left-0 z-40' : 'absolute top-auto -left-full duration-[2.5s] opacity-0 -z-50'}`
                }
                aria-label="Sidenav">
                <div className="w-64 h-full bg-white shadow-lg dark:bg-slate-900 dark:border-gray-700 rounded-xl mr-3" aria-label="Sidenav">
                    ...
                    <div className="justify-center p-4 pt-0 space-x-4 w-full lg:flex bg-white dark:bg-slate-900 z-20 rounded-b-xl">
                        ...
                        <div className="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-slate-900" id="language-dropdown">
            ...
            // <div className="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800 z-50">
