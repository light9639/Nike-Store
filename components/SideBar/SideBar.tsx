...
export default function SideBar(props: DropType): JSX.Element {
    ...
    function handleScroll() {
        if (props.ScrollY < 2200) {
            props.setScrollY(window.pageYOffset);
            props.setScrollActive(false);
        }
        else if (props.ScrollY > 299) {
            props.setScrollY(window.pageYOffset);
            props.setScrollActive(true);
        } else {
            props.setScrollY(window.pageYOffset);
            props.setScrollActive(false);
        }
    ...
    return (
        <React.Fragment>
            ...
            >
                <div className={props.ScrollActive ? "fixed top-10 z-50" : ""}>
                    <div
                        className={`h-full bg-white shadow-lg dark:bg-slate-900 dark:border-gray-700 rounded-xl mr-3" aria-label="Sidenav
