                ...
                <div className="mx-0 sm:mx-6">
                    <div className="bg-white dark:bg-slate-900 shadow-md rounded-md w-full p-8 mb-28 md:p-24 text-xl md:text-2xl text-gray-800 dark:text-white leading-normal">
                        ...
                        <div className='text-xl'>
                            ...
                            <Fade>
                                <blockquote className="border-l-4 border-gray-900 mt-10 -mb-2 pl-8 md:pl-12">지금 <Link href="/Login" className='font-semibold hover:opacity-75'>로그인 페이지</Link>로 이동 후,<br /> 가입하여 혜택을 누려보세요 </blockquote>
                            </Fade>
                        </div>
                    </div>
                </div>
