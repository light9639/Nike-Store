                                    ...
                                    <div className="flex items-center">
                                        <div className="flex items-center">
                                            <span className="flex items-center my-3 md:my-0">
                                                <svg fill={Star?.first} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className={`h-5 w-5 flex-shrink-0 ${Star?.first == "currentColor" ? "text-yellow-500" : "stroke-yellow-400 dark:stroke-none dark:fill-white"}`} viewBox="0 0 24 24">
                                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                                                </svg>
                                                <svg fill={Star?.second} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className={`h-5 w-5 flex-shrink-0 ${Star?.second == "currentColor" ? "text-yellow-500" : "stroke-yellow-400 dark:stroke-none dark:fill-white"}`} viewBox="0 0 24 24">
                                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                                                </svg>
                                                <svg fill={Star?.third} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className={`h-5 w-5 flex-shrink-0 ${Star?.third == "currentColor" ? "text-yellow-500" : "stroke-yellow-400 dark:stroke-none dark:fill-white"}`} viewBox="0 0 24 24">
                                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                                                </svg>
                                                <svg fill={Star?.four} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className={`h-5 w-5 flex-shrink-0 ${Star?.four == "currentColor" ? "text-yellow-500" : "stroke-yellow-400 dark:stroke-none dark:fill-white"}`} viewBox="0 0 24 24">
                                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                                                </svg>
                                                <svg fill={Star?.five} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className={`h-5 w-5 flex-shrink-0 ${Star?.five == "currentColor" ? "text-yellow-500" : "stroke-yellow-400 dark:stroke-none dark:fill-white"}`} viewBox="0 0 24 24">
                                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                                                </svg>
                                            </span>
                                        </div>
                        ...
                        <div className='flex flex-wrap lg:justify-between max-w-screen-xl mx-auto mb-20 p-4 pt-0 lg:p-8 border-t'>
                            <div className='w-full lg:w-1/3 mb-10 lg:mb-0'>
                                <div className="flex items-center mb-3">
                                    ...
                                    <svg aria-hidden="true" className={`w-5 h-5 ${Star?.second == "currentColor" ? "text-yellow-400" : "stroke-yellow-400 dark:stroke-none text-white"}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                    </svg>
                                    <svg aria-hidden="true" className={`w-5 h-5 ${Star?.third == "currentColor" ? "text-yellow-400" : "stroke-yellow-400 dark:stroke-none text-white"}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                    </svg>
                                    <svg aria-hidden="true" className={`w-5 h-5 ${Star?.four == "currentColor" ? "text-yellow-400" : "stroke-yellow-400 dark:stroke-none text-white"}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                    </svg>
                                    <svg aria-hidden="true" className={`w-5 h-5 ${Star?.five == "currentColor" ? "text-yellow-400" : "stroke-yellow-400 dark:stroke-none text-white"}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                    </svg>
                                    <p className="ml-2 text-sm font-medium text-gray-900 dark:text-white">{Shoe[ID]?.Review} out of 5</p>
                                </div>
                                ...
                                <div className="flex items-center mt-4">
                                    ...
                                    <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                                        <div className={`h-5 bg-yellow-400 rounded ${Shoe[ID]?.Review == 5 ? 'w-full' : 'w-0'}`}></div>
                                    </div>
                                    <span className="text-sm font-medium text-blue-600 dark:text-blue-500">{Shoe[ID]?.Review == 5 ? '100%' : '0%'}</span>
                                </div>
                                <div className="flex items-center mt-4">
                                    <span className="text-sm font-medium text-blue-600 dark:text-blue-500">4 star</span>
                                    <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                                        <div className={`h-5 bg-yellow-400 rounded ${Shoe[ID]?.Review == 4 ? 'w-full' : 'w-0'}`}></div>
                                    </div>
                                    <span className="text-sm font-medium text-blue-600 dark:text-blue-500">{Shoe[ID]?.Review == 4 ? '100%' : '0%'}</span>
                                </div>
                                <div className="flex items-center mt-4">
                                    <span className="text-sm font-medium text-blue-600 dark:text-blue-500">3 star</span>
                                    <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                                        <div className={`h-5 bg-yellow-400 rounded ${Shoe[ID]?.Review == 3 ? 'w-full' : 'w-0'}`}></div>
                                    </div>
                                    <span className="text-sm font-medium text-blue-600 dark:text-blue-500">{Shoe[ID]?.Review == 3 ? '100%' : '0%'}</span>
                                </div>
                                <div className="flex items-center mt-4">
                                    <span className="text-sm font-medium text-blue-600 dark:text-blue-500">2 star</span>
                                    <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                                        <div className={`h-5 bg-yellow-400 rounded ${Shoe[ID]?.Review == 2 ? 'w-full' : 'w-0'}`}></div>
                                    </div>
                                    <span className="text-sm font-medium text-blue-600 dark:text-blue-500">{Shoe[ID]?.Review == 2 ? '100%' : '0%'}</span>
                                </div>
                                <div className="flex items-center mt-4">
                                    <span className="text-sm font-medium text-blue-600 dark:text-blue-500">1 star</span>
                                    <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                                        <div className={`h-5 bg-yellow-400 rounded ${Shoe[ID]?.Review == 1 ? 'w-full' : 'w-0'}`}></div>
                                    </div>
                                    <span className="text-sm font-medium text-blue-600 dark:text-blue-500">{Shoe[ID]?.Review == 1 ? '100%' : '0%'}</span>
                                </div>
                            </div>
