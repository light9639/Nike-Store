                                        ...
                                        <div className="rounded-xl ml-3 hover:shadow-2xl transform hover:scale-105 duration-500">
                                            ...
                                            <div className="dark:bg-slate-800 p-5 flex flex-col gap-2">
                                                ...
                                                <div className="mt-5 flex gap-2">
                                                    ...
                                                    <button className="flex flex-grow items-center rounded-md bg-gray-300 hover:bg-gray-400 dark:bg-slate-600 dark:hover:bg-slate-400"><FontAwesomeIcon icon={faHeart} className="w-5 m-auto" /></button>
                                                    <button className="flex flex-grow items-center rounded-md bg-gray-300 hover:bg-gray-400 dark:bg-slate-600 dark:hover:bg-slate-400"><FontAwesomeIcon icon={faEye} className="w-5 m-auto" /></button>
                                                </div>
