        ...
        <React.Fragment>
            ...
            <div className='max-w-screen-lg mx-auto h-full py-24'>
                ...
                <div className='mx-2 lg:mx-0'>
                    ...
                    <Fade>
                        <div className="dark:bg-gray-800 text-gray-600 dark:text-white rounded-xl">
                            <h2>
                                <button
                                    type="button"
                                    className="flex items-center justify-between w-full p-5 font-bold text-left text-gray-900 border border-b-0 border-gray-200 rounded-t-xl dark:border-gray-700 dark:bg-slate-900 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 text-base md:text-lg"
                            ...
                            <h2>
                                <button
                                    type="button"
                                    className="flex items-center justify-between w-full p-5 font-bold text-left text-gray-900 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-slate-900 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 text-base md:text-lg"
                            ...
                            <h2>
                                <button
                                    type="button"
                                    onClick={() => { PressButton(5) }}
                                    className={
                                        flyer[5] === true
                                            ? "flex items-center justify-between w-full p-5 font-bold text-left text-gray-900 border border-gray-200 dark:border-gray-700 dark:bg-slate-900 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 text-base md:text-lg"
                                            : "flex items-center justify-between w-full p-5 font-bold text-left text-gray-900 border border-gray-200 dark:border-gray-700 dark:bg-slate-900 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-b-xl text-base md:text-lg"}
                                >
                                    <span className="flex items-center">
                                        <svg className="w-5 h-5 mr-2 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path>
