        ...
        <React.Fragment>
            ...
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                            ...
                            <Fade>
                                <div className="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
                                    <div className="space-y-3 text-center lg:text-left">
                                        ...
                                        <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">지속 가능한 미래.</h1>
                                    ...
                                    <div className="space-y-3 text-center lg:text-left">
                                        ...
                                        <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">새 생명을 불어넣는 일.</h1>
                                    ...
                                    <div className="space-y-3 text-center lg:text-left">
                                        ...
                                        <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">너만을 위한 특별한 나이키</h1>
                                    ...
                                    <div className="space-y-3 text-center lg:text-left">
                                        ...
                                        <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">시작을 만들다.</h1>
                ...
                <div className="2xl:container 2xl:mx-auto mt-24 lg:mt-36 mb-36">
                    <Fade>
                        <h2 className="text-center text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Our Team</h2>
                    ...
                    <Fade>
                        <p className="max-w-2xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300 text-sm lg:text-base px-5 lg:px-0">
