    ...
    return (
        <React.Fragment>
            ...
            <div className='flex flex-wrap flex-col-reverse lg:flex-row lg:flex-nowrap justify-between max-w-screen-2xl mx-auto my-10 lg:my-20 p-5 md:p-4 2xl:p-0 border-none md:border'>
                <div className='w-full lg:w-2/5 xl:w-1/3 h-full lg:h-[600px] xl:h-[800px] overflow-hidden lg:overflow-scroll dark:bg-gray-900 rounded-2xl mt-10 lg:mt-0 border dark:border-none scrollbar-thin scrollbar-thumb-gray-900 scrollbar-track-gray-100 scrollbar-thumb-rounded-full scrollbar-track-rounded-full'>
