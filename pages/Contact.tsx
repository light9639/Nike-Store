...
export default function Contact(): JSX.Element {
    ...
    return (
        <React.Fragment>
                ...
                <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                    <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20 dark:bg-slate-900">
                        <div className="max-w-md mx-auto">
                            <div>
                                <Fade bottom cascade><h1 className="text-3xl font-extrabold">문의하기</h1></Fade>
                                <Fade bottom cascade><p className="mt-7">Nike 사이트에 오신 것을 환영합니다. 연락을 원하시거나 궁금한 점이 있다면 언제든지 문의 부탁드립니다.</p></Fade>
                            ...
                            <div className="divide-y divide-gray-200">
                                <form className="pt-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7 -mb-8">
                                    <label className="block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2" htmlFor="grid-first-name">
                                        <Fade bottom cascade>이름</Fade>
                                    </label>
                                    <Fade><input required className="appearance-none block w-full bg-gray-200 dark:bg-white text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="이름" /></Fade>
                                    <label className="block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2" htmlFor="grid-first-name">
                                        <Fade bottom cascade>이메일</Fade>
                                    </label>
                                    <Fade><input required className="appearance-none block w-full bg-gray-200 dark:bg-white text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="email" placeholder="이메일" /></Fade>
                                    <label className="block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2" htmlFor="grid-first-name">
                                        <Fade bottom cascade>메시지</Fade>
                                    </label>
                                    <Fade><textarea required className="resize-y py-3 px-4 border focus:outline-none rounded-md w-full bg-gray-200 dark:bg-white" placeholder="메시지를 입력하세요..."></textarea></Fade>
            ...
            <section className="max-w-screen-xl mx-auto bg-white dark:bg-gray-900 rounded-xl">
