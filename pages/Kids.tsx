                        ...
                        <div className='mt-8 lg:mt-3 float-none lg:float-right'>
                            {
                                span.map(function (a: string, i: number) {
                                    return (
                                        <span className='px-2 py-2 sm:px-4 sm:py-3 bg-red-600 m-1 text-white font-semibold rounded-md text-xs lg:text-base'><a href='#void'>{a}</a></span>
                                    )
                                })
                            }
                        </div>
