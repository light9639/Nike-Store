                ...
                <Fade>
                    <form className='max-w-3xl my-10 mx-6 md:mx-auto w-auto md:w-[98%] lg:w-full'>
                        ...
                        <div className="relative">
                            ...
                            <button type="button" className="text-white absolute right-0 bottom-0 bg-gray-900 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-r-full border border-black text-sm p-4 w-24 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                        </div>
                    </form>
                </Fade>
