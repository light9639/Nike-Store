...
// function Photos(props: RouteType): JSX.Element {
...
// function Photos2(props: RouteType): JSX.Element {
...
//             </p>
//             <div className="mt-4 sm:mt-6">
//               <a href="#" className="Black_border" onClick={() => props.router.push(`/Detail/${5}`)}>더 알아보기</a>
//               <a href="#" className="Black_box" onClick={() => props.router.push(`/Detail/${5}`)}>구매하기</a>
//             </div>
//           </div>
//         </div>
//       </div>
...
// function Trending(props: RouteType): JSX.Element {
...
// function Minimal(props: RouteType): JSX.Element {
//   return (
//     <>
//       <section className="section--showcase min-h-full py-20">
//         <div className="container mx-auto px-4">
