    ...
    return (
        <React.Fragment>
            ...
            <div className='max-w-5xl mx-auto my-20 space-y-5 tracking-tighter px-5 sm:px-10 xl:p-0'>
                <Fade>
                    <h1 className='text-3xl md:text-4xl font-bold'>구매 이용약관</h1>
                    <br />
                    <h2 className='text-xl font-bold'>제1장 총칙</h2>
                    <div className='space-y-3'>
                        <div className='space-y-3'>
                            <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제1조 (목적)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제2조 (용어의 정의)</h3>
                        <p className='text-gray-600 dark:text-gray-200 font-semibold text-sm'>본 약관에서 정하는 용어의 정의는 다음과 같습니다.</p>
                        ...
                        <p className='text-gray-600 dark:text-gray-200 font-semibold text-sm'>이용자란 사이트에 접속하거나 회사가 직접 운영하거나 제휴 된 공식 매장에 방문하여 이 약관에 따라 회사가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.</p>
                        ...
                        <p className='text-gray-600 dark:text-gray-200 font-semibold text-sm'>개별계약이란 이용자가 회사의 특정 상품이나 용역의 구매를 신청하고 회사가 이에 대해 승낙하는 것을 말합니다.</p>
                    ...
                    <h2 className='text-xl font-bold'>제3조 (약관의 명시 효력 및 변경)</h2>
                    <div className='space-y-3'>
                    ...
                    <h2 className='text-xl font-bold'>제2장 서비스의 이용</h2>

                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제4조 (서비스의 제공)</h3>
                        <p className='text-gray-600 dark:text-gray-200 font-semibold text-sm'>회사는 다음과 같은 서비스를 제공합니다.</p>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제5조 (서비스의 중단)</h3>
                    ...
                    <h2 className='text-xl font-bold'>제3장 회원가입계약</h2>

                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제6조 (회원가입)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제7조(회원 탈퇴 및 자격상실)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제8조(회원에 대한 통지)</h3>
                    ...
                    <h2 className='text-xl font-bold'>제4장 개별계약</h2>

                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제9조(구매신청)</h3>
                        <p className='text-gray-600 dark:text-gray-200 font-semibold text-sm'>이용자는 이하의 방법에 의하여 구매를 신청합니다.</p>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제9조의 1 (HYPE 상품 구매관련 특약)</h3>
                    ...
                    <div className='ml-5 space-y-3'>
                        <div className='space-y-3'>
                            <h3 className='text-base text-gray-900 font-semibold dark:text-white'>참가방식</h3>
                        ...
                        <div className='space-y-3'>
                            <h3 className='text-base text-gray-900 font-semibold dark:text-white'>참가규칙</h3>
                        ...
                        <div className='space-y-3'>
                            <h3 className='text-base text-gray-900 font-semibold dark:text-white'>당첨자 선정</h3>
                        ...
                        <div className='space-y-3'>
                            <h3 className='text-base text-gray-900 font-semibold dark:text-white'>결제 및 배송</h3>
                            <p className='text-gray-600 dark:text-gray-200 font-semibold text-sm'>무작위 선정 방식</p>
                        ...
                        <div className='space-y-3'>
                            <h3 className='text-base text-gray-900 font-semibold dark:text-white'>선착순 방식</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제9조의 2 (사전 주문 관련 특약)</h3>
                    ...
                    <div className='ml-5'>
                        <div className='space-y-3'>
                            <h3 className='text-base text-gray-900 font-semibold dark:text-white'>참가 규칙</h3>
                            <div className='space-y-3'>
                                <p className='text-gray-600 dark:text-gray-200 font-semibold text-sm'>사전 주문(Pre-order)</p>
                        ...
                        <div className='space-y-3 mt-3'>
                            <p className='text-gray-600 dark:text-gray-200 font-semibold text-sm'>대기자 명단(Waitlist)</p>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제10조  (개별 계약의 성립)</h3>
                    ...
                    <h2 className='text-xl font-bold'>제5장 대금결제</h2>
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제11 조 (수신확인통지)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제12조 (대금결제방법)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제13조 (포인트제도의 운영)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제14조 (쿠폰의 정의 및 사용)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'> 제15조 (연체)</h3>
                    ...
                    <h2 className='text-xl font-bold'>제6장 배송, 취소, 환불</h2>

                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제16조(재화 등의 공급 등)</h3>
                        ...
                        <div className='space-y-3 ml-5'>
                            <h3 className='text-base text-gray-900 font-semibold dark:text-white'>2배송소요기간은 주문일 익일을 기산일로 하며 비수기를 기준으로 다음 각호와 같습니다.</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제17조 (환불, 반품 및 대행)</h3>
                    ...
                    <h2 className='text-xl font-bold'>제7장 회사와 이용자의 의무사항</h2>
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제18조 (개인정보보호 )</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제19조 (회사의 의무)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제20조(이용자의 의)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제21조 (회원의 아이디 및 비밀번호 등 계정관리)</h3>
                    ...
                    <h2 className='text-xl font-bold'>제8장 기타</h2>

                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제22조 (지적재산권의 보호)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제23조 (게시물, 상품평 등의 관리)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제24조 (면책조항)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제25조 (분쟁해결)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제26조 (손해배상 등)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제27조 (재판권 및 준거법)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제28조 (약관 외 준칙)</h3>
                    ...
                    <div className='space-y-3'>
                        <h3 className='text-base text-gray-900 font-semibold dark:text-white'>제29조 (기타 조항)</h3>
