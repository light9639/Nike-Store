                ...
                <div className="container mx-auto flex flex-wrap py-6">
                    ...
                    <section className="w-full md:w-2/3 flex flex-col items-center px-3">
                        ...
                        <article className="flex flex-col shadow my-4">
                            <img src={list[ID]?.src} alt={list[ID]?.alt} />
                        ...
                        <div className="w-full flex pt-6">
                            <a href="#" className="w-1/2 bg-white dark:bg-slate-900 shadow hover:shadow-md text-left p-6">
                            ...
                            <a href="#" className="w-1/2 bg-white dark:bg-slate-900 shadow hover:shadow-md text-right p-6">
                        ...
                        <div className="w-full flex flex-col text-center md:text-left md:flex-row shadow bg-white dark:bg-slate-900 mt-10 mb-10 p-6">
                            <div className="w-full md:w-1/5 flex justify-center md:justify-start pb-4">
                                <img src="https://avatars.githubusercontent.com/u/95972251?v=4" className="rounded-full shadow h-32 w-32" />
                            </div>
