...
import { LoginType } from './Type/TypeBox';
...
const LoginData = [
    ...
    },
    {
        ...
        class: "w-full text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex justify-center items-center dark:focus:ring-[#24292F]/55 mr-2",
                        ...
                        {data?.user ? (
                            <React.Fragment>
                                ...
                                <form className="space-y-4 md:space-y-6" action="">
                                    <div className='text-center'>
                                        <Fade><img className='mx-auto h-full mb-5 rounded-md' src={`${data?.user?.image}`} alt="profile" /></Fade>
                                        <Fade bottom><p className='mb-2'>환영합니다 <span className='text-blue-600 font-semibold'>{data?.user?.name}</span>님</p></Fade>
                                        <Fade bottom>
                                            <button
                                                onClick={() => signOut()}
                                                type="button"
                            ...
                            <React.Fragment>
                                ...
                                <form className="space-y-4 md:space-y-6" action="#">
                                    <Fade bottom>
                                        {
                                            LoginData.map(function (item: LoginType, idx: number) {
                                                return (
                                                    <React.Fragment>
                                                        <button
                                                            type="button"
